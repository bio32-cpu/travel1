...
<div class="top-header">
	<div class="container">
		<ul class="tp-hd-lft wow fadeInLeft animated" data-wow-delay=".5s">
			...
			<li class="prnt"><a href="tour-history.php">Lịch sử tour của tôi</a></li>
...
<div class="top-header">
	<div class="container">
		<ul class="tp-hd-lft wow fadeInLeft animated" data-wow-delay=".5s">
			...
			<li class="hm"><a href="admin/index.php">Quản lí đăng nhập</a></li>

		</ul>
		<ul class="tp-hd-rgt wow fadeInRight animated" data-wow-delay=".5s"> 
			<li class="tol">Số điện thoại : 8386</li>				
					...
					<nav class="cl-effect-1">
						<ul class="nav navbar-nav">
							...
							<li><a href="page.php?type=aboutus">Giới Thiệu</a></li>
								<li><a href="package-list.php">Tham Quan</a></li>
								...
								<?php if($_SESSION['login'])
{?>
								<li>Giup dow?<a href="#" data-toggle="modal" data-target="#myModal3">  Ý kiến  </a>  </li>
								<?php } else { ?>
								<li><a href="enquiry.php">  </a>  </li>
								<?php } ?>
								<div class="clearfix"></div>
